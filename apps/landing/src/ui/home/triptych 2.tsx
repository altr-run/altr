			...
			<div className={s.triptychIn}>
				...
				<div className={s.triptychGrid}>
					...
					<Reveal delay={160} className={s.tripCell}>
						...
						<p>
							The same context follows the work all the way
							through. No retyping the brief. No drifting
							acceptance criteria. No lost rationale when
							the PR lands for review.
						</p>
