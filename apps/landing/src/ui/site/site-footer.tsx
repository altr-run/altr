...
const COL_HEAD =
	'font-mono text-[10.5px] uppercase tracking-widest text-white/30 mb-[18px] font-medium'

const NAV_LINK =
	'block font-sans text-[13.5px] text-white/45 py-[4px] transition-colors duration-150 hover:text-white no-underline leading-snug'
		...
		<footer className="bg-zinc-950">
					...
					<div className="flex items-center justify-between gap-10">
						...
						<div className="flex items-center gap-6">
							<a href="/" className="inline-flex items-center leading-none text-current no-underline">
								<LogoMark className="h-[26px] brightness-[10] saturate-0 opacity-90" />
								<span className="sr-only">Altr</span>
							</a>
							<p className="text-white/40 m-0 font-serif text-[15px] leading-[1.45] italic">
								One execution loop for product teams and agents.
							</p>
						</div>
						{/* Social links */}
						<div className="flex items-center gap-4 flex-shrink-0">
							<a href="https://twitter.com/altr_run" className="text-white/30 hover:text-white transition-colors" aria-label="Twitter / X" rel="noopener noreferrer" target="_blank">
							...
							<a href="https://github.com/altr-run" className="text-white/30 hover:text-white transition-colors" aria-label="GitHub" rel="noopener noreferrer" target="_blank">
							...
							<a href="https://linkedin.com/company/altr-run" className="text-white/30 hover:text-white transition-colors" aria-label="LinkedIn" rel="noopener noreferrer" target="_blank">
				...
				<div className="mx-auto px-8 py-4" style={{ maxWidth: 'var(--maxw)' }}>
					<div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3">
						{[
							...
							<div
								key={pill}
								className="flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest text-white/35"
							>
			...
			<div className="px-8 py-5">
				<div className="mx-auto flex items-center justify-between" style={{ maxWidth: 'var(--maxw)' }}>
					...
					<div className="flex items-center gap-2 border border-white/12 rounded-full px-4 py-1.5 bg-white/5">
